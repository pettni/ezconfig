...
{
  auto d1 = EZ_JSON_CREATE(TBase, nlohmann::json::parse(R"(
  {
    "d1": "hello"
  }
)"));
  ...
  auto d2 = EZ_JSON_CREATE(TBase, nlohmann::json::parse(R"(
  {
    "d2": 123
  }
)"));
...
{
  auto d3 = EZ_JSON_CREATE(TBase, nlohmann::json::parse(R"(
  {
    "d3": {
        "x": 1,
        "y": 2
...
{
  REQUIRE_THROWS(EZ_JSON_CREATE(TBase, nlohmann::json::parse(R"(
  {
    "d1": "hello",
    "d2": 123
  }
